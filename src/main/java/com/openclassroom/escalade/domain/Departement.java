...
public enum Departement {
	...
	alpes_maritimes("Alpes-Maritime"),
	ardeche("Ardèche"),
	ariege("Ariège"),
	aude("Aude"),
	auvergne("Auvergne"),
	aveyron("Aveyron"),
	bas_rhin("Bas-Rhin"),
	bouches_du_rhone("Bouches-du-Rhônes"),
	bourgogne("Bourgogne"),
	charente("Charente"),
	corse_du_sud("Corse-du-Sud"),
	cotes_darmor("Côtes-d'Armor"),
	doubs("Doubs"),
	drome("Drôme"),
	finistere("Finistère"),
	gard("Gard"),
	...
	hautes_alpes("Haute-Alpes"),
	hautes_pyrenees("Haute-Pyrénées"),
	herault("Hérault"),
	isere("Isère"),
	jura("Jura"),
	...
	meuse("Meuse"),
	moselle("Moselle"),
	pyrenees_atlantique("Pyrénées-Atlantiques"),
